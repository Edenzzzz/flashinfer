...
seq_configs=(
    "8192 0 0 0 128"       # 0k prefill, 8k decode
    "4096 1024 1024 1 128" # 1k prefill, 4k decode
    "8192 1024 1024 1 128" # 1k prefill, 8k decode
    "8192 2048 2048 1 128" # 2k prefill, 8k decode
    "1024 4096 4096 1 128" # 4k prefill, 1k decode
    ...
    "0 8192 8192 1 0"      # 8k prefill, 0k decode
...
for config in "${seq_configs[@]}"; do
    ...
    python3 benchmarks/bench_batch_attention.py \
        ...
        --prefill_len $prefill_len --overwrite
    ...
    if [ $? -eq 0 ]; then
        ...
        python3 benchmarks/plotting/plot_persistent_individual.py
...
ls -la ${save_dir}/persistent_comparison_*.png
echo "=========================================="
